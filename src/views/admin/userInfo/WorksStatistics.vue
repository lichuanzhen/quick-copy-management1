...
<template>
    <div v-loading.body="listLoading">
        ...
        <el-table :data="dataList" stripe border style="width: 100%">
            <el-table-column prop="time" label="微信号"></el-table-column>
            ...
            <el-table-column prop="totalUser" label="发布时间"></el-table-column>
        </el-table>
...
<script>
import { getWorksWStatisticsList, exportWorksStatisticsList } from '../../../api/admin/userInfo';
export default {
    data() {
        return {
            listLoading: false,
    ...
    methods: {
        ...
        getDataList() {
            ...
            getWorksWStatisticsList(this.searchItems, this.pageSize, this.currentPage).then(response => {
